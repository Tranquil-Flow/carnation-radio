...
The project's PLAN.md and CONTEXT.md previously recommended either a TypeScript port or ONNX-based neural watermarking (IDEAW/XAttnMark). This spec supersedes both with Rust/WASM for the following reasons:
...
PLAN.md and CONTEXT.md should be updated to reflect this decision when implementation begins.
